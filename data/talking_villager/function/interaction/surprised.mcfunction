...
execute if score $villager_msg eden.technical matches 1 run function talking_villager:messages/surprised/alive
execute if score $villager_msg eden.technical matches 2 run function talking_villager:messages/surprised/arrival
...
advancement revoke @s only talking_villager:surprised